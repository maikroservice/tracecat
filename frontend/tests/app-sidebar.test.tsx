...
describe("AppSidebar", () => {
  ...
  it("does not render the MCP servers nav entry", () => {
    // This fork hides the MCP servers entry from the workspace sidebar
    // (kept with visible: false); upstream asserts active-state highlighting
    // here instead.
    ...
    expect(
      screen.queryByRole("link", { name: "MCP servers" })
